...
ws2 =  wb2.active
ws2.title = "Positions"
wb2.save(filename = 'PosCODE2.xlsx')

wb2 = xl.load_workbook('PosCODE2.xlsx') 
ws2 = wb2.active
...
xls_file = pd.ExcelFile('PosCODE2.xlsx') # Import the excel file and call it xls_file
...
df_merge_col.to_excel('PosCODE2.xlsx',index=False)#use this method to save to csv, traditinal format, better than excel
...
wb = load_workbook('PosCODE2.xlsx')
...
wbP = load_workbook('PTRCODE2.xlsx')
...
wb.save(filename = 'PosCODE2.xlsx')
